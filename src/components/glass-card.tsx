...
>(({ className, ...props }, ref) => {
  ...
  return (
    <Card
      ref={ref}
      className={cn(
        "ripple-effect rounded-xl backdrop-blur-sm border border-border/20 shadow-lg transition-all duration-300 hover:shadow-[0_0_25px_8px] hover:shadow-orange-500/30 hover:scale-[1.02] animate-energy-wave",
        className
      )}
