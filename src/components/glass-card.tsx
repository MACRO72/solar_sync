...
>(({ className, ...props }, ref) => {
  ...
  return (
    <Card
      ref={ref}
      className={cn(
        "ripple-effect rounded-2xl backdrop-blur-sm border border-border/20 shadow-lg transition-all duration-300 hover:shadow-[0_0_20px_5px] hover:shadow-yellow-500/30 hover:scale-[1.02] animate-energy-wave",
        className
      )}
